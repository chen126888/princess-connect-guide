...
import YoutubeChannelsSection from '../../components/ClanBattle/YoutubeChannelsSection';
import AttributeSelector from '../../components/ClanBattle/AttributeSelector';
import CommonCharactersSection from '../../components/ClanBattle/CommonCharactersSection';
import Card from '../../components/Common/Card';
import CompensationKnifeContentSection from '../../components/ClanBattle/CompensationKnifeContentSection';
...
const ClanBattle: React.FC = () => {
  ...
  const config = clanBattleConfigs; // Assuming a single config object for now
    ...
    <PageContainer>
      ...
      {activeAttribute === 'compensationKnife' ? (
        config.compensationKnifeContent && (
          <CompensationKnifeContentSection content={config.compensationKnifeContent} allCharacters={characters} />
        )
      ) : (
        config.commonCharacters && (
